...
import Illustration from '../assets/images/cup_object.svg'; // Example path to your illustration
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-cyan-100 to-cyan-50 flex items-center justify-center">
        <div className="flex bg-white rounded-lg shadow-lg overflow-hidden max-w-4xl w-full">
          ...
          <div className=" md:block w-1/2 p-8 flex items-center justify-center">
            <img
              src={Illustration}
          ...
          <div className="w-full md:w-1/2 p-8">
            <h2 className="text-2xl font-bold text-center text-cyan-600 mb-6">Welcome Back</h2>
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <a href="/forgot-password" className="text-cyan-600 font-medium hover:underline">Forgot Password?</a>
              </div>
             {/* Login Button */}
